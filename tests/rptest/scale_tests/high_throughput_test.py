...
CloudTierConfigs = {
    ...
    "AWS-1": CloudTierConfig(
         25*MiB,  75*MiB,  3,  3, 512*MiB,  300*GiB,   20, 1000,  1500, 1*hours, 16*GiB
    ),
    "AWS-2": CloudTierConfig(
         50*MiB, 150*MiB,  3,  3, 512*MiB,  500*GiB,   50, 2000,  3750, 1*hours, 64*GiB
    ),
    "AWS-3": CloudTierConfig(
        100*MiB, 200*MiB,  6,  6, 512*MiB,  500*GiB,  100, 5000,  7500, 1*hours, 64*GiB
    ),
    "AWS-4": CloudTierConfig(
        200*MiB, 400*MiB,  6,  6,   1*GiB, 1000*GiB,  100, 5000, 15000, 1*hours, 96*GiB
    ),
    "GCP-1": CloudTierConfig(
         25*MiB,  50*MiB,  3,  3, 512*MiB,  300*GiB,   20,  500,  1500, 1*hours,  8*GiB
    ),
    "GCP-2": CloudTierConfig(
         50*MiB, 150*MiB,  3,  3, 512*MiB,  300*GiB,   50, 1000,  3750, 1*hours, 32*GiB
    ),
    "GCP-3": CloudTierConfig(
        100*MiB, 300*MiB,  6,  6, 512*MiB,  300*GiB,  100, 3000,  7500, 1*hours, 32*GiB
    ),
    "GCP-4": CloudTierConfig(
        150*MiB, 450*MiB,  9,  9, 512*MiB,  300*GiB,  100, 5000, 15000, 1*hours, 32*GiB
    ),
    "GCP-5": CloudTierConfig(
        400*MiB, 600*MiB, 12, 12,   1*GiB,  600*GiB,  200, 5000, 15000, 1*hours, 32*GiB
    ),
}
# yapf: enable
